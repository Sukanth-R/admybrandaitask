  ...
  return (
    <nav className="bg-white shadow-sm fixed top-0 left-0 right-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div 
          className={`
            transform md:hidden transition-all duration-300 ease-in-out
            ${isMenuOpen 
        ...
        >
          <div className="pt-2 pb-3 space-y-1">
            <Link 
              href="#features"
              className="block px-3 py-2 text-base font-medium text-gray-700 hover:text-indigo-600 hover:bg-gray-50 w-full text-left"
          ...
          <div className="pt-4 pb-3 border-t border-gray-200">
            <div className="space-y-3 p-4">
              <Button 
                variant="outline" 
                size="sm" 
                className="w-full justify-center transition-transform duration-200 hover:scale-[1.02]"
                onClick={() => {
                  handleMenuClose();
                  openForm('signin');
                }}
